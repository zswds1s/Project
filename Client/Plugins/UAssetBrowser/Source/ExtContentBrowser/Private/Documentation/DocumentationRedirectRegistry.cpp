...
bool FExtDocumentationRedirectRegistry::Register(const FName& Owner, const FDocumentationRedirect& Redirect)
{
...
void FExtDocumentationRedirectRegistry::UnregisterAll(const FName& Owner)
{
...
bool FExtDocumentationRedirectRegistry::GetRedirect(const FString& Link, FDocumentationRedirect& OutRedirect) const
{
